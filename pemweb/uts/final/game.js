...
var quotes_array_html = [
    ...
    '<div class="header_text">Ketepatan(%)</div>'
];
var quotes_array_js = [
...
var quotes_array_css = [
    ...
    'background-color: peachpuff; height: 60px; width: 70px;',
    '#hasilmu { font-size: 20px; width: 80%; display: none }',
    '.incorrect_char { color: red; text-decoration: underline }'
];

//mendefinisikan variabel penampung untuk kata-kata yang akan ditulis 
var quotes_array = []
...
function selectquotes() {
    ...
    //melakukan pengecekan pada nilai selection yang dipilih user dan menampungnya pada quotes_array
...
//menyeleksi element html dan menampungnya pada variabel penampung
var timer_text = document.querySelector(".curr_time");
...
function processCurrentText() {
    ...
    //proses mengoreksi inputan pengguna
...
function updateTimer() {
    if (timeLeft > 0) {
        ...
        //mengupdate text di timer sesuai dengan waktu yang berjalan
...
function finishGame() {
    ...
    //menampilkan kata restart untuk memulai kembali pada quotes
    ...
    //menghitung cpm dengan cara (karakter yang ditulis /7)/ waktu pengerjaan)* 60 lalu dibulatkan
    ...
    //menampilkan elemen hasil, cpm, wpm, ketepatan dan error 
